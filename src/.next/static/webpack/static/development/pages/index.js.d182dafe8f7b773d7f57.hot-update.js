...
})(["padding-top:16px;padding-bottom:16px;@media (min-width:768px){padding-top:40px;padding-bottom:40px;}&:after{content:\"\";display:block;clear:both;}.right-area{button,text{float:right;}text{color:#fff;}}.notification{position:relative;top:-6px;margin-right:40px;}.show,.show .menu{display:block;}@media (min-width:768px){.close{display:none;}}"]);

/***/ })

})
//# sourceMappingURL=index.js.d182dafe8f7b773d7f57.hot-update.js.map